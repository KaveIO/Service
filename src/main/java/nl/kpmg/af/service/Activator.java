...
public class Activator extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(nl.kpmg.af.service.service.EdgeService.class);
        resources.add(nl.kpmg.af.service.service.LayerService.class);
        resources.add(nl.kpmg.af.service.service.NodeService.class);
    }
}
