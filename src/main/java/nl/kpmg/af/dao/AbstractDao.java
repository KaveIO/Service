...
public abstract class AbstractDao {
    ...
    // private static final String CONNECTION_STRING = "mdb-001:27017"
    ...
    /***
     * AbstractDao Constructor in which we connect to the MongoDB using a
     * MongoClient.
     *
    ...
    public AbstractDao(String connectionString, String dbName) {
        if (mongoDB == null) {
            // TODO Should get the connection string, db name, user, and
            // password from config.
            this.connectionString = connectionString.isEmpty() ? CONNECTION_STRING
                    : connectionString;
            ...
            try {
                ...
                boolean auth = mongoDB.authenticate("overwatch",
                        "bla123".toCharArray());
                if (auth) {
            ...
            /*
             * Do not close finally { mongoClient.close(); }
             */
        }
    }
